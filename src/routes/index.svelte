<script>
  ...
  let photoCandidates = album.photos.filter(
    (photo) => !photo.mimeType.includes("video")
  );
...
<svelte:head>
  ...
  <meta
    property="og:image"
    content="https://www.modu-blues.com/img/cloud9.png"
  />
...
{#if party && !sharingStyle}
  <snowfall>
    {#each Array(50) as a}
      <snowflake><img src="img/heart.png" />️</snowflake>
    {/each}
  </snowfall>
{/if}
...
<main>
  {#if sharingStyle}
    <Container>
      ...
      <Row>
        <Col xs="6"
          ><Button on:click={handleClickShare} color="primary" block>
            공유하기</Button
          ></Col
        >
        <Col xs="6"
          ><Button on:click={handleClickCopy} color="primary" block>
            복사하기</Button
          ></Col
        >
      </Row>
  ...
  <div bind:this={shareElement}>
    <center>
      <h1 class="title" hidden={!showTitle || gallery} contentEditable>
        {title}
      </h1>

      <div class="cta" class:sharingStyle class:listStyle hidden={gallery}>
        <a href={ctaUrl}>
      ...
      <div class="totals" class:listStyle hidden={!showTotals}>
        ...
        <span class="men">남{numMen}</span>&nbsp;<span class="women"
          >여{numWomen}</span
        >
      </div>
    </center>
    ...
    <ul class="members-container" class:sharingStyle class:listStyle>
      {#each members as member}
        <li
          class="member"
          style="background-image: url({`${member.backgroundImage}`})"
        >
          {#if member.referals}
          ...
          {/if}
          <div class={`${member.sex} ${member.referer ? "new" : ""}`}>
            {member.name}
          </div>
        </li>
      {/each}
  ...
  <div class:sharingStyle class:listStyle>
    <center>
      <div class:sharingStyle class:listStyle hidden={gallery}>
        <a
          href="https://www.facebook.com/groups/cloud9.dancehall"
          class="fa fa-facebook"
        />
        {#if subdomain != "balboa"}
          <a
            href="https://www.instagram.com/modublues/"
            class="fa fa-instagram"
          />
          <a href="https://cafe.naver.com/modudance" class="fa fa-coffee" />
        {/if}
      </div>
      <a
        href="https://docs.google.com/spreadsheets/d/{sheetsId}/edit#gid=1296169145"
        >구글 시트 보기</a
      >
...
<style>
  ...
  .message {
    font-size: 1.1em;
    font-weight: bold;
    text-shadow: 0 0 0.2em gold, 0 0 0.5em gold, 0 0 0.5em gold, 0 0 0.5em gold,
      0 0 0.2em gold, 0 0 0.5em gold, 0 0 0.5em gold, 0 0 0.5em gold,
      0 0 0.2em gold, 0 0 0.5em gold, 0 0 0.5em gold, 0 0 0.5em gold,
      0 0 0.2em gold, 0 0 0.5em gold, 0 0 0.5em gold, 0 0 0.5em gold;
  ...
  li.member {
    ...
    text-shadow: 0 0 0.2em white, 0 0 0.5em white, 0 0 0.5em white,
      0 0 0.5em white, 0 0 0.2em white, 0 0 0.5em white, 0 0 0.5em white,
      0 0 0.5em white, 0 0 0.2em white, 0 0 0.5em white, 0 0 0.5em white,
      0 0 0.5em white, 0 0 0.2em white, 0 0 0.5em white, 0 0 0.5em white,
      0 0 0.5em white;
  ...
  li .new {
    text-shadow: 0 0 0.2em lightgreen, 0 0 0.5em lightgreen,
      0 0 0.5em lightgreen, 0 0 0.5em lightgreen, 0 0 0.2em lightgreen,
      0 0 0.5em lightgreen, 0 0 0.5em lightgreen, 0 0 0.5em lightgreen,
      0 0 0.2em lightgreen, 0 0 0.5em lightgreen, 0 0 0.5em lightgreen,
      0 0 0.5em lightgreen, 0 0 0.2em lightgreen, 0 0 0.5em lightgreen,
      0 0 0.5em lightgreen, 0 0 0.5em lightgreen;
  }
